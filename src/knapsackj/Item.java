...
/**
 * The Item class for KnapsackJ.
 * Implements Comparable so that a collection of items may be sorted.
 * @author tcc10a
 */
public class Item implements Comparable<Item> 
{
    ...
    /**
     * The comparison function for items.
     * Compares item i to the current item.
     * @param i the item to compare to.
     * @return -1 if i is not more valuable, +1 is i is more valuable, 
     * 0 if there is no gain or loss.
     */
